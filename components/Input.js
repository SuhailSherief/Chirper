    ...
    return (
        ...
        <div className="w-full divide-y divide-gray-700">
            <div className={`${selectedFile && "pb-7"} ${input && "space-y-2.5"}`}>
                <textarea onChange={(e) => setInput(e.target.value)} value={input} rows="2" placeholder="What's happening?" className="bg-transparent outline-none text-[#d9d9d9] placeholder-gray-500 tracking-wide w-full min-h-[50px]" />
                {selectedFile && (
                <div className="relative">
                    <div className="absolute w-8 h-8 bg-[#25282c] hover:bg-[#272c26] bg-opacity-75 rounded-full flex items-center justify-center top-1 left-1 cursor-pointer" onClick={() => setselectedFile(null)}>
        ...
        {!loading && (
            ...
            <div className="flex items-center">
                ...
                {
                showEmojis &&( <Picker onSelect={addEmoji} style={{
                position:"absolute",
                marginTop: "456px",
                marginLeft: -40,
                maxWidth: "320px",
